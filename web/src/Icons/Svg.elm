...
import Svg exposing (Svg, svg, path, g, node)
...
chestClose =
    customIcon
        [ g [ attribute "stroke-width" "2.53", attribute "transform" "matrix(.865 0 0 .865 28.7 9.96)" ]
            [ node "rect" [ attribute "height" "11.5", attribute "ry" "1.33", attribute "width" "24.6", attribute "x" "-31.5", attribute "y" "3.31" ] []
            , path [ d "m-19.2-5.41c-3.32 0-6.34 0.887-8.6 2.4-2.27 1.52-3.82 3.75-3.82 6.32 2.73 0.115 24.5 0.261 24.9 0 0-2.56-1.55-4.8-3.82-6.32-2.27-1.52-5.29-2.4-8.61-2.4z" ] []
            , node "circle" [ attribute "cx" "-18.9", attribute "cy" "8.65", attribute "r" "1.74" ] []
            ]
        ]
...
chestOpen =
    customIcon
        [ g [ attribute "stroke-width" "2.49", attribute "transform" "matrix(.865 0 0 .865 28.7 9.96)" ]
            [ node "rect"
                [ attribute "height" "11.4", attribute "ry" "1.31", attribute "width" "24.3", attribute "x" "-31.4", attribute "y" "3.27" ]
                []
            , path [ d "m-17.6-9.18c-3.22-0.594-6.3-0.276-8.77 0.789-2.47 1.06-4.38 2.95-4.84 5.44 2.63 0.601 23.7 4.64 24.1 4.45 0.46-2.49-0.648-4.93-2.57-6.81-1.93-1.88-4.7-3.28-7.91-3.87z" ]
                []
            ]
        ]
